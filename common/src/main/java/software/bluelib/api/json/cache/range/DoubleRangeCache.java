...
public record DoubleRangeCache(
	...
	@NotNull
	public static final Codec<DoubleRangeCache> CODEC = NbtCodecUtils.fromNbt(DoubleRangeCache::readFromNBT, DoubleRangeCache::writeToNBT);

	@NotNull
	public static final DataComponentType<DoubleRangeCache> DOUBLE_RANGE_DATA = NbtCodecUtils.persistentDataType(CODEC);
