...
public class VertexConsumerNullException extends NullPointerException {

	private final List<String> messages;

	public VertexConsumerNullException(String pMessage) {
		super(pMessage);
		this.messages = Collections.singletonList(pMessage);
	}

	public VertexConsumerNullException(List<String> pMessages) {
	...
	@NotNull
	public VertexConsumerNullException withMessage(String pMessage) {
		List<String> newMessages = new ArrayList<>(this.messages);
		newMessages.add(pMessage);
		return new VertexConsumerNullException(newMessages);
	}
	...
	public String toString() {
		return "VertexConsumerNullException: " + getLocalizedMessage();
	}
}
