...
public record ModelDescriptionDeserializer(
	...
	@NotNull
	public static JsonDeserializer<ModelDescriptionDeserializer> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			return new ModelDescriptionDeserializer(
					animationArmsDown,
