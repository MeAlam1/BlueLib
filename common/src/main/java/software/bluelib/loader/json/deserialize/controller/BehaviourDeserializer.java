...
public record BehaviourDeserializer(
		@NotNull List<String> conditions,
		@Nullable Integer priority,
		@NotNull Map<String, StateDeserializer> states) {

	@NotNull
	public static JsonDeserializer<BehaviourDeserializer> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			Map<String, StateDeserializer> states = JsonUtils.jsonObjToMap(statesObj, context, StateDeserializer.class);

			return new BehaviourDeserializer(
					conditions,
					priority,
					states);
		};
