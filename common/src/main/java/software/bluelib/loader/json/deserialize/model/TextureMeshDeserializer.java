...
public record TextureMeshDeserializer(
	...
	@NotNull
	public static JsonDeserializer<TextureMeshDeserializer> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			return new TextureMeshDeserializer(
					pivot,
					position,
					rotation,
					scale,
