...
public record EntityDeserializer(
		@NotNull String formatVersion,
		@NotNull Map<String, VariantDeserializer> variants) {

	@NotNull
	public static JsonDeserializer<EntityDeserializer> deserializer() throws JsonParseException {
