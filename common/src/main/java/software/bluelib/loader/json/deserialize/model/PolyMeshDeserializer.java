...
public record PolyMeshDeserializer(
		@Nullable Boolean normalizedUVs,
		@NotNull List<Float> normals,
		@Nullable PolysUnionDeserializer polysUnionDeserializer,
		@NotNull List<Float> positions,
		@NotNull List<Float> uvs) {

	@NotNull
	public static JsonDeserializer<PolyMeshDeserializer> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			PolysUnionDeserializer polysUnionDeserializer = JsonUtils.getOptionalObject(obj, "polys", context, PolysUnionDeserializer.class);
			...
			return new PolyMeshDeserializer(
					normalizedUVs,
					normals,
					polysUnionDeserializer,
					positions,
					uvs);
		};
	}
