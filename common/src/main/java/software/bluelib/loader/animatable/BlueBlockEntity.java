...
public interface BlueBlockEntity extends BlueAnimatable {
    ...
    default <D> void setAnimData(SerializableDataTicket<D> dataTicket, D data) {
        ...
        if (level == null) {
            //BlueLibConstants.LOGGER.error("Attempting to set animation data for BlockEntity too early! Must wait until after the BlockEntity has been set in the world. (" + blockEntity.getClass().toString() + ")");
    ...
    default void triggerAnim(@Nullable String controllerName, String animName) {
        ...
        if (level == null) {
            //BlueLibConstants.LOGGER.error("Attempting to trigger an animation for a BlockEntity too early! Must wait until after the BlockEntity has been set in the world. (" + blockEntity.getClass().toString() + ")");
    ...
    default void stopTriggeredAnim(@Nullable String controllerName, @Nullable String animName) {
        ...
        if (level == null) {
            //BlueLibConstants.LOGGER.error("Attempting to stop a triggered animation for a BlockEntity too early! Must wait until after the BlockEntity has been set in the world. (" + blockEntity.getClass().toString() + ")");
