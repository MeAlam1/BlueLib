...
public record EntityAnimTriggerPacket(
		...
		@NotNull String animName) implements NetworkPacket<EntityAnimTriggerPacket> {

	@NotNull
	public static final ResourceLocation ID = BlueResource.resource("entity_anim_trigger");
	...
	public static @NotNull EntityAnimTriggerPacket decode(@NotNull RegistryFriendlyByteBuf pBuffer) {
